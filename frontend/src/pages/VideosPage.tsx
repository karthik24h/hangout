    ...
    <div className="dashboard videos-page">
      ...
      <div className="dash-shell">
        ...
        <main className="dash-main videos-main">
          <div className="videos-heading"><div><p className="videos-eyebrow">WATCH TOGETHER</p><h1>Make it a movie night.</h1><p className="videos-lede">Bring your people together around the moments worth sharing.</p></div>{!roomCode && <button className="videos-button videos-button--primary" onClick={() => setCreate(true)}><Icon name="plus" /> New video room</button>}</div>
